...
f_call_set_var   CO_I_ENVAR_PATH[0]  ${BA_PATH}/data   # only method = ENVAR
...
#==================================================================================
f_call_set_var   CO_I_TRG         0                   # 0|1: use trace gas forecast
...
f_call_set_var CO_BIN_ADJ     ${BA_PATH}/bin/adjust_sst_snow_V2_19
###################################################################################
#
#
###################################################################################
