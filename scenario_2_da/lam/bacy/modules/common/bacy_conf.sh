...
case "$BA_SITE_HPC" in
  ...
  HOREKA_CPU)
    ...
    ;;	
  LEONARDO_GPU)
    f_call_set_var  BA_PATH        /leonardo_work/DE360_GLORI/smr_prod/scenarios/scenario_2/bacy_data
    ;;
esac
###################################################################################
#
...
#----------------------------------------------------------------------------------
f_call_set_var  BA_ICON_GRIDDIR   ${BA_ROUTFOXFOX}/icon/grids # note: different from other scenarios
...
case "$1" in
  ...
  ICON-LAM)
    ...
    f_call_set_var BA_L_OBSDIR[LHN]   ${BA_L_OBSDIR[CONV]}
    ;;
esac
...
#==================================================================================
f_call_set_var BA_ENSIZE_ASS       5  # ensemble size (for assimilation forecasts)
#----------------------------------------------------------------------------------
case "$1" in
  COSMO|ICON-LAM)
    f_call_set_var BA_ENSIZE_MAIN      5      # ensemble size (for main forecasts)
    ;;
  ICON)
