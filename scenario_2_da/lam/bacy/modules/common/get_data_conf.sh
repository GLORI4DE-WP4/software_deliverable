...
case "$BA_SITE_HPC" in
  ...
  LEONARDO_GPU)
    f_call_set_var  DA_CDO_BIN    \
           ${BA_PATH}/bin/cdo      #/leonardo/prod/spack/03/install/0.19/linux-rhel8-icelake/gcc-11.3.0/cdo-2.1.0-2ltng25xbm7yakxoon4dyehxev5ynaw2/bin/cdo
    ;;   
esac
###################################################################################
#
...
f_call_set_var DA_OBS_RADAR             0                             # radar (0|1)
f_call_set_var DA_OBS_LIGHTNING         0                         # lightning (0|1)
f_call_set_var DA_OBS_LHN               0               # latent heat nudging (0|1)
f_call_set_var DA_OBS_MODES             1                             # MODES (0|1)
f_call_set_var DA_OBS_GNSS              1                 # GNSS ZTD (E-GVAP) (0|1)
f_call_set_var DA_OBS_SST               0                               # SST (0|1)
